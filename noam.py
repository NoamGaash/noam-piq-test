...
@torch.no_grad()
def main():
    img_fake = "/home/noam/Documents/4-4 dataset/output/casia-no-bg/all_subjects/results/WS30/CASIA/Dataset_IUV_from_appearance_0000/0000/00/001/001.png"
    img_real = "/home/noam/Documents/4-4 dataset/output/casia-no-bg/all_subjects/Crop256/rgb/0000/00/001/001.png"

    # Read RGB image and it's noisy version
    x = torch.tensor(imread(img_fake)[:,:,:3].copy()).permute(2, 0, 1)[None, ...] / 255.

    y = torch.tensor(imread(img_real)[:,:,:3].copy()).permute(2, 0, 1)[None, ...] / 255.
